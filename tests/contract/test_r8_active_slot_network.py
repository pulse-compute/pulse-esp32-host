...
def c_common_args(tmp_path: Path, source: str, exe_name: str) -> tuple[list[str], Path]:
    ...
    sources = [
        ...
        FW / "components/wdc_app_slots/wdc_app_slots.c",
        FW / "components/wdc_bundle/wdc_bundle.c",
        FW / "components/wdc_caps/wdc_caps.c",
        FW / "components/wdc_control/wdc_control.c",
        ...
        FW / "components/wdc_host_identity/wdc_host_identity.c",
        FW / "components/wdc_host_identity/wdc_host_fingerprint_generated.c",
